...
if __name__ =="__main__":
    ...
    #2) Length_sweep
    SIMULATION_NAME="length_sweep"
    opt_mmi_length=32*2e-6
    Lengths=np.linspace(opt_mmi_length-3e-6,opt_mmi_length+3e-6,5)
    ...
    if OPT_LENGTH==None:
        OPT_LENGTH=32*2e-6  #default value
    ...
    Widths=np.linspace(opt_width_ridge-0.5e-6,opt_width_ridge+0.5e-6,5)
