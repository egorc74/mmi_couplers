...
if __name__=="__main__":
    ...
    n_core=1.9963
    cladding=0
    geometry(sim=lumapi.MODE(),filename=filename,wavelength=wavelength,wg_length=wg_length,wg_width=wg_width,width_ridge=width_ridge,
