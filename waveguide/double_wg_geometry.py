...
def double_wg_geometry(sim, filename,gap):
    ...
    sim.set("y",0)         
    sim.set("y span",100e-6)
    sim.set("z min",-thick_BOX-thick_Substrate-thick_Si3N4/2)     
...
if __name__=="__main__":
    ...
    n_core=1.9963
    cladding=0
    double_wg_geometry(sim=lumapi.MODE(filename),filename=filename,width_ridge=1.6e-6)
