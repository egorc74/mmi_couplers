...
def taper_width_colormap(
    ...
    try:
        ...
        np.save(rf"C:\Users\egorc\FAKS_FE\LPVO\no_cladding_mmi\python_mmi_design\mmi_1x2\930nm\data\{data_filename}.npy",transmission_matrix)
...
if __name__=="__main__":
    ...
    data_filename="taper_width_colormap_3500_9200nm"
