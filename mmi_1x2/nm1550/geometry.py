...
def geometry(sim, filename,width_ridge,mmi_length,taper_width,taper_width_in, delta_y,thick_BOX=thick_BOX):
    ...
    sim.set("y",0)         
    sim.set("y span",Y_span+5e-6)
    sim.set("z min",-thick_BOX-thick_Si3N4/2-thick_Substrate)     
